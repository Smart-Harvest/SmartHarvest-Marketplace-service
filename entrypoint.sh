...
echo "=== Marketplace Service Starting ==="
...
echo "Starting Marketplace Service on port ${PORT:-8003}..."
exec uvicorn app.main:app --host 0.0.0.0 --port ${PORT:-8003} --log-level info
